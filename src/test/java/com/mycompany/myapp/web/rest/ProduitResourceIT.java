...
class ProduitResourceIT {
    ...
    private static final Float DEFAULT_PRICE = 0.01F;
    ...
    void createProduit() throws Exception {
        ...
        assertThat(testProduit.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    void putExistingProduit() throws Exception {
        ...
        assertThat(testProduit.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
    }
    ...
    void partialUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.price(UPDATED_PRICE).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
