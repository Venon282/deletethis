...
class ClientResourceIT {
    ...
    private static final String DEFAULT_PHONE = "8";
    private static final String UPDATED_PHONE = "2";

    private static final String DEFAULT_EMAIL = "zJ@V^U14rbS";
    private static final String UPDATED_EMAIL = "vRK@zy3k5N";
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getActivated()).isEqualTo(DEFAULT_ACTIVATED);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        assertThat(testClient.getActivated()).isEqualTo(UPDATED_ACTIVATED);
    }
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.lastName(UPDATED_LAST_NAME).address(UPDATED_ADDRESS).activated(UPDATED_ACTIVATED);
