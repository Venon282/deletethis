    ...
    public ResponseEntity<Commande> partialUpdateCommande(
        ...
        Optional<Commande> result = commandeRepository
            ...
            .map(existingCommande -> {
                ...
                if (commande.getDeliveryLatitude() != null) {
                    existingCommande.setDeliveryLatitude(commande.getDeliveryLatitude());
                }
                if (commande.getDeliveryLongitude() != null) {
                    existingCommande.setDeliveryLongitude(commande.getDeliveryLongitude());
                }
                if (commande.getDeliveryDistance() != null) {
                    existingCommande.setDeliveryDistance(commande.getDeliveryDistance());
                }
                if (commande.getDeliveryFees() != null) {
                    existingCommande.setDeliveryFees(commande.getDeliveryFees());
                }
