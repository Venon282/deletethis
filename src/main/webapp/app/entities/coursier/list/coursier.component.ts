...
import { EntityArrayResponseType, CoursierService } from '../service/coursier.service';
...
export class CoursierComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICoursier): number => this.coursierService.getCoursierIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.coursiers = this.refineData(dataFromBody);
  }

  protected refineData(data: ICoursier[]): ICoursier[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: ICoursier[] | null): ICoursier[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.coursierService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
